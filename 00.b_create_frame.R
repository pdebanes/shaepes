...
# province_territoire_mapping <- province_territoire_mapping %>%
#   bind_rows(
#     province_territoire_mapping %>% filter(territoire == "beni") %>% mutate(territoire = "beni-ville")
#   ) |> 
#   bind_rows(
#     province_territoire_mapping %>% filter(territoire == "nyiragono") %>% mutate(territoire = "beni-ville")
#   )
